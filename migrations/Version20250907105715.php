...
final class Version20250907105715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association (id SERIAL NOT NULL, name VARCHAR(190) NOT NULL, slug VARCHAR(190) NOT NULL, content TEXT NOT NULL, owner_id INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_by VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_by VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
